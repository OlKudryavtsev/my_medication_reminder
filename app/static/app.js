  ...
  async function loadCourses(){
    ...
    try{
      ...
      if(root) root.innerHTML = '<div class="empty">Не удалось загрузить назначения. Закройте и откройте приложение заново. Если повторяется — пришлите лог консоли.</div>';
      toast('Ошибка загрузки назначений');
    }
  }
